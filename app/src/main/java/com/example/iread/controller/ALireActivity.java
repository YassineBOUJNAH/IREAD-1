...
public class ALireActivity extends BaseActivity {


    private CollectionReference bookRef = UserHelper.getUsersCollection().document(getCurrentUser().getUid()).collection("WantToRead");
